...
const service = SERVICES.find((s) => s.slug === "hooldus-ja-edasiarendus") as ServiceItem;
const PATH = "/hooldus-ja-edasiarendus";

export const Route = createFileRoute("/hooldus-ja-edasiarendus")({
  head: () => ({
    meta: pageMeta({
