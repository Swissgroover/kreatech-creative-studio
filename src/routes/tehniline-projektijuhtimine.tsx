...
const service = SERVICES.find((s) => s.slug === "tehniline-projektijuhtimine") as ServiceItem;
const PATH = "/tehniline-projektijuhtimine";

export const Route = createFileRoute("/tehniline-projektijuhtimine")({
  head: () => ({
    meta: pageMeta({
