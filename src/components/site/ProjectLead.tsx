        ...
        <div className="relative overflow-hidden rounded-3xl border border-border bg-surface/60 p-5 backdrop-blur sm:p-8 md:p-16">
          <div className="grid items-center gap-10 md:grid-cols-12 md:gap-12">
            <Reveal className="md:col-span-7">
              ...
              <h2 className="font-display text-[2rem] font-semibold leading-[1.05] tracking-tight text-balance [hyphens:auto] [overflow-wrap:break-word] sm:text-4xl md:text-5xl lg:text-6xl">
                {t.lead.title[0]}
